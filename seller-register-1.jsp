		...
		<div class="container padding-bottom-3x mb-2">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form class="row" action="seller-register-1" method="post">
						<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group">
				<label for="store-name">Store name</label> <input
					class="form-control" name="storeName" type="email" id="store-name"
					required>
			</div>
...
<!-- Mirrored from
themes.rokaux.com/unishop/v3.0/template-1/account-login.html by HTTrack
Website Copier/3.x [XR&CO'2014], Sat, 16 Jun 2018 11:06:41 GMT
 --></html>
-->
 --%>