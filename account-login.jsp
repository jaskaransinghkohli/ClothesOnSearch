...
<body>
		...
		<nav class="site-menu">
			<ul>
				...
				<li><a href="account-orders.html"><span>Account</span></a>
					...
					<!-- 	<li><a href="user-login">Sell with Us</a> -->
	...
	<div class="offcanvas-wrapper">
		...
		<div class="container padding-bottom-3x mb-2">
			<div class="row">
				<div class="col-md-6">
					<form class="login-box" action="customer-login" method="post">


						<div class="form-group input-group">
							<input class="form-control" name="customerEmail" type="email" placeholder="Email"
								required><span class="input-group-addon"><i
								class="icon-mail"></i></span>
						</div>
						<div class="form-group input-group">
							<input class="form-control" name="customerPassword" type="password"
				...
				<div class="col-md-6">
					...
					<form class="row" action="register-customer" method="post">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="reg-fn">First Name</label> <input
									class="form-control" name ="customerName" type="text" id="reg-fn" required>
							</div>
						</div>
					<!-- 	<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label for="reg-email" >E-mail Address</label> <input
									class="form-control" name="customerEmail" type="email" id="reg-email" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="reg-phone">Contact Number</label> <input
									class="form-control" type="text" name ="customeMobileNumber" id="reg-phone" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="reg-pass">Password</label> <input
									class="form-control" name="customerPassword" type="password" id="reg-pass" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="reg-pass-confirm">Confirm Password</label> <input
									class="form-control" name="customerPassword" type="password" id="reg-pass-confirm"
									required>
							</div>
						</div>
